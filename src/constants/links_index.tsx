...
export const footerSocials = [
  ...
  },
  {
    id: "discord",
    name: "Discord",
    href: "https://discord.gg/4xp8BtwVgR",
...
// PDF links (resume and research paper)
// Option 1: Direct downloads (recommended) - place PDFs in public/ folder
// Option 2: GitHub links - use raw GitHub file URLs like: "https://github.com/username/repo/raw/main/resume.pdf"
export const pdfLinks = [
  {
    id: "resume",
    name: "Resume",
    href: "/Assets/Documents/ramon_resume.pdf", // Direct download from public folder (recommended)
    // href: "https://github.com/username/repo/raw/main/resume.pdf", // Alternative: GitHub link
...
// Combined links for footer (socials + PDFs)
export const allFooterLinks = [...footerSocials, ...pdfLinks] as const;
